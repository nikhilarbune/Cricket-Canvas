    ...
    <footer class="bg-gray-900 pt-12 pb-6 px-10 font-[sans-serif] tracking-wide">
        <div class="max-w-screen-xl mx-auto">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <img src="<?php echo BASE_URL; ?>/assets/images/logo11.png" alt="Cricket Canvas" class='w-48' />
            </a>
                </div>
            ...
            <p class='text-gray-300 text-sm mt-10'>Copyright © Cricket Canvas All rights reserved.
            </p>
        </div>
    </footer>
<!-- footer end -->
