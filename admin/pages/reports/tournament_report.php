...
<div class="p-4 sm:ml-64 mt-14">
    <div class="p-4 border-2 border-gray-200 rounded-lg">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold">Tournament Report</h1>
        </div>
        ...
        <div class="mb-6">
            <form method="GET" class="flex gap-4">
                ...
                <select name="status" class="p-2 border rounded-lg">
                    ...
                    <option value="registration_closed" <?php echo $status_filter === 'registration_closed' ? 'selected' : ''; ?>>Registration Closed</option>
