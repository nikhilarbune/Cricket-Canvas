...
<head>
    ...
    <title>Cricket Canvas Admin</title>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="<?php echo BASE_URL; ?>/admin" class="flex ms-2 md:me-24">
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">Cricket Canvas</span>
                    </a>
                </div>
                    ...
                    <div class="flex items-center ms-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow" id="dropdown-user">
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <a href="<?php echo BASE_URL; ?>/auth/logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Logout</a>
                                </li>
                            </ul>
                        </div>
                    </div>
